      ...
      <div class="col-md-6 col-lg-3">
        <form>
          <div class="form-floating mb-3">
            <input type="email" class="form-control" id="floatingInput" placeholder="請輸入電子郵件" v-model='user.username' />
          ...
          <!-- 點擊觸發 loginPost -->
          <button type="button" class="w-100 h-25 btn btn-success" @click="loginPost">
            登入
          </button>
        </form>
      </div>
